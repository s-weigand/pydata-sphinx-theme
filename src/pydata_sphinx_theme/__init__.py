...
def update_and_remove_templates(
    ...
    # Specify whether search-as-you-type should be used or not, if it is available.
    if "theme_search_as_you_type" in context:
        search_as_you_type = str(context["theme_search_as_you_type"]).lower()
        app.add_js_file(
            None,
            body=f"DOCUMENTATION_OPTIONS.search_as_you_type = {search_as_you_type};",
        )
